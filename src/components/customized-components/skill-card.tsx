                ...
                {active && typeof active === "object" ? (
                    <div className="fixed inset-0 grid place-items-center z-[100] p-4">
                        ...
                        <motion.div
                            ...
                            ref={ref}
                            className="w-full max-w-[500px] h-[90vh] md:h-auto md:max-h-[90%] flex flex-col bg-white dark:bg-neutral-900 rounded-xl overflow-hidden overflow-y-auto">
                            <motion.div layoutId={`image-${active.name}-${id}`}>
                                <div className="w-full h-40 md:h-52 bg-neutral-100 dark:bg-neutral-800 flex justify-center items-center">
                                    <img
                                        width={80}
                                        height={80}
                                        src={active.icon}
                            ...
                            <div className="p-4 md:p-6">
                                <div className="flex justify-between items-start">
                                    <div className="">
                                        <motion.h3
                                            ...
                                            className="font-medium text-neutral-700 dark:text-neutral-200 text-lg md:text-xl">
                                            {active.name}
                                        </motion.h3>
                                        <motion.p
                                            layoutId={`description-${active.description}-${id}`}
                                            className="text-neutral-600 dark:text-neutral-400 text-sm md:text-base mt-2">
                                            {active.description}
                                        </motion.p>
                                    </div>
                                </div>
                                <div className="mt-6">
                                    <motion.div
                                        ...
                                        <h4 className="text-neutral-900 dark:text-white font-medium mb-4">Related Technologies</h4>
